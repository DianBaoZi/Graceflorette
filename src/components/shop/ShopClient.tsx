    ...
    if (priceRange !== "all") {
      switch (priceRange) {
        case "under-50":
          ...
          break;
        case "50-80":
          results = results.filter((p) => p.price >= 50 && p.price <= 80);
          break;
        case "over-80":
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-4">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            ...
            <select
              ...
              className="bg-white text-xs text-warm-gray border border-primary/25 rounded-full px-4 py-2.5 focus:outline-none focus:border-primary-dark/50 transition-colors"
            >
